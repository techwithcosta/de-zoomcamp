# python 06_spark_sql_local_cluster.py \
#     --input_green=data/pq/green/2020/*/ \
#     --input_yellow=data/pq/yellow/2020/*/ \
#     --output=data/report/report-2020

# URL="spark://desktop:7077"
# spark-submit \
#     --master="${URL}" \
#     06_spark_sql_local_cluster.py \
#         --input_green=data/pq/green/2021/*/ \
#         --input_yellow=data/pq/yellow/2021/*/ \
#         --output=data/report/report-2021

# run local spark cluster
# !cd /home/costa/spark/spark-3.5.0-bin-hadoop3/sbin
# !./start-master.sh
# !./start-worker.sh spark://desktop:7077
# after finishing
# !./stop-master.sh
